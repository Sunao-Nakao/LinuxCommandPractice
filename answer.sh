...
　sunaomitani@sunaonoMacBook-Air ~ % cd ~

# 3. カレントディレクトリから`~/geekationWorkspace`ディレクトリまで移動してください。(すでにオリエンテーションで作成済み)
sunaomitani@sunaonoMacBook-Air ~ % cd geekationWorkspace

# 4. `LinuxCommandPractice`というディレクトリを作成して、`LinuxCommandPractice`に移動してください。
sunaomitani@sunaonoMacBook-Air geekationWorkspace % mkdir LinuxCommandPractice
sunaomitani@sunaonoMacBook-Air geekationWorkspace % cd LinuxCommandPractice

# 5. カレントディレクトリのパスを表示してください。
sunaomitani@sunaonoMacBook-Air LinuxCommandPractice % pwd
/Users/sunaomitani/geekationWorkspace/LinuxCommandPractice
...
sunaomitani@sunaonoMacBook-Air LinuxCommandPractice % ls -a
.		..		.git		README.md

# 8. `LinuxCommandPractice`ディレクトリ内に`practice_dir_1`ディレクトリを作成してください。
sunaomitani@sunaonoMacBook-Air LinuxCommandPractice % mkdir practice_dir_1

# 9. `LinuxCommandPractice`ディレクトリ内に`practice_dir_1`ディレクトリが作成されていることを確認(表示)してください。
sunaomitani@sunaonoMacBook-Air LinuxCommandPractice % ls
...
sunaomitani@sunaonoMacBook-Air LinuxCommandPractice % mkdir ./practice_dir_1/practice_dir_2

# 11. `LinuxCommandPractice`ディレクトリ内から**移動せずに**、`practice_dir_1`内に`practice_dir_2`ディレクトリが作成されていることを確認(表示)してください。**但し、相対パスを使用してください。**
sunaomitani@sunaonoMacBook-Air LinuxCommandPractice % ls ./practice_dir_1
practice_dir_2
...
sunaomitani@sunaonoMacBook-Air LinuxCommandPractice % touch ./practice_dir_1/practice_dir_2/practice_file1.txt ./practice_dir_1/practice_dir_2/practice_file2.txt

# 13 `practice_dir_2`に移動してください。**但し、相対パスを使用してください。**
sunaomitani@sunaonoMacBook-Air LinuxCommandPractice % cd practice_dir_1/practice_dir_2

# 14. `practice_file1.txt`を2つ上の階層のディレクトリ(`LinuxCommandPractice`)へ**移動**してください。**但し、相対パスを使用してください。**
sunaomitani@sunaonoMacBook-Air practice_dir_2 % mv practice_file1.txt ../../LinuxCommandPractice

# 15. `practice_file2.txt`を2つ上の階層のディレクトリ(`LinuxCommandPractice`)へ**コピー**してください。**但し、相対パスを使用してください。**
sunaomitani@sunaonoMacBook-Air practice_dir_2 % cp practice_file2.txt ../../LinuxCommandPractice

# 16. カレントディレクトリの`practice_file2.txt`を削除してください。**但し、相対パスを使用してください。**
sunaomitani@sunaonoMacBook-Air practice_dir_2 % rm practice_file2.txt

# 17. `practice_file2.txt`が削除されていることを確認(表示)してください。
sunaomitani@sunaonoMacBook-Air practice_dir_2 % ls -a
.	..

# 18. 2つ上の階層のディレクトリ(`LinuxCommandPractice`)へ移動してください。**但し、相対パスを使用してください。**
sunaomitani@sunaonoMacBook-Air practice_dir_2 % cd ../..

# 19. `practice_dir_2`ディレクトリを削除してください。**但し、相対パスを使用してください。**
sunaomitani@sunaonoMacBook-Air LinuxCommandPractice % rm -r practice_dir_1/practice_dir_2

# 20. `vi`または`vim`を用いて、カレントディレクトリにある`practice_file1.txt`に`I'm good at Linux commands!`と書き込んでください。
sunaomitani@sunaonoMacBook-Air LinuxCommandPractice % vim practice_file1.txt

# 21. `practice_file1.txt`に書き込んだ内容を出力してください。
sunaomitani@sunaonoMacBook-Air LinuxCommandPractice % cat practice_file1.txt
